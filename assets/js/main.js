...
47. portfolio panel
48. addClass removeClass
49. ScrollMagic Controller
50. scroll with moving text
51. text-scale-anim
52. tp-text-right-scroll
53. tp-text-invert
54. tp-text-invert-2
55. tp-text-invert-3
56. Fade Effect With Scroll
57. project anim
58. choose anim
59. work anim
60. award anim
61. studio-project animation
62. portfolio panel
63. addClass removeClass
64. ScrollMagic Controller
65. scroll with moving text
66. text-scale-anim
67. tp-text-right-scroll
68. tp-text-invert
69. tp-text-invert-2
70. tp-text-invert-3
71. Fade Effect With Scroll
72. project anim
73. choose anim
74. work anim
75. award anim
76. studio-project animation
77. portfolio panel
78. addClass removeClass
79. ScrollMagic Controller
80. scroll with moving text
81. text-scale-anim
82. tp-text-right-scroll
83. tp-text-invert
84. tp-text-invert-2
85. tp-text-invert-3
86. Fade Effect With Scroll
87. project anim
88. choose anim
89. work anim
90. award anim
...
(function ($) {
	...
	// vanilla fallback — hides preloader even if jQuery/GSAP fails
	window.addEventListener('load', function () {
		setTimeout(function () {
			var el = document.getElementById('preloader');
			if (el) { el.style.transition = 'opacity 0.5s ease'; el.style.opacity = '0'; setTimeout(function(){ el.style.display = 'none'; }, 500); }
			var el2 = document.getElementById('loading');
			if (el2) el2.style.display = 'none';
		}, 800);
	});
	// hard timeout — never stuck on loading (e.g. JS error before load)
	setTimeout(function(){
		var el = document.getElementById('preloader');
		if (el && getComputedStyle(el).display !== 'none') {
			el.style.transition = 'opacity 0.5s ease'; el.style.opacity = '0'; setTimeout(function(){ el.style.display='none'; }, 500);
		}
	}, 3500);
	...
	// 17. scroll wrapper //
	try { gsap.registerPlugin(ScrollTrigger, ScrollSmoother, ScrollToPlugin); } catch(e) {}
	try {
	...
	if ($('.tp--hover-item').length) {
		let hoverAnimation__do = function (t, n) {
			let a = new hoverEffect({
				parent: t.get(0),
				intensity: t.data("intensity") || 2.5,
				speedIn: t.data("speedin") || 0.3,
				speedOut: t.data("speedout") || 0.3,
				easing: t.data("easing") || void 0,
				hover: t.data("hover") || void 0,
				image1: n.eq(0).attr("src"),
				image2: n.eq(1).attr("src") || n.eq(0).attr("src"),
	...
	$(".anim-zoomin").each(function() {
		// guard: skip hero slider (handled by vanilla fade)
		if ($(this).closest(".hero-slider").length) return;
